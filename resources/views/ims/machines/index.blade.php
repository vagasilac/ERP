...
@section('title') {{ trans('Utilaje') }} <a href="{{ action('MachinesController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adăugare') }}</a> @endsection

@section('content')
    <div class="content-fluid">
        <div class="actions-bar clearfix" data-target="#machines-table">
        ...
        <div class="filters-bar clearfix" data-target="#machines-table">
            <div class="col-xs-12">
        ...
        <div class="table-responsive marginT30 list-container">
            @include('ims.machines._machines_list');
        </div>
    </div>
@endsection
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['MachinesController@multiple_destroy'], 'method' => 'DELETE']) !!}

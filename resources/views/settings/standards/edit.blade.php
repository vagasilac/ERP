...
@section('title') {{ $standard->name }} @endsection

@section('content')
    <div class="content-fluid">
        {!! Form::model($standard, ['action' => ['SettingsController@standards_update', $standard->id], 'id' => 'saveForm', 'files' => true]) !!}
        <div class="page-header col-xs-12">
            <h2>{{ trans('Editare standard') }}</h2>

...
@section('title') {{ $material->name }} @endsection

@section('content')
    <div class="content-fluid">
        {!! Form::model($material, ['action' => ['SettingsController@materials_update', $material->id, $type], 'id' => 'saveForm', 'files' => true]) !!}
        <div class="page-header col-xs-12">
            <h2>{{ trans('Editare material') }}</h2>
        ...
        <div class="col-md-10">
            <div class="col-xs-12 col-sm-6 marginR15">
                ...
                @if ($type == 'main' || $type == 'other')
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="AL" class="control-label">{{ trans('Grosime') }}</label>

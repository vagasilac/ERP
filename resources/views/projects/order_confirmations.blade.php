        ...
        <div class="paddingL15 paddingR15">
            ...
            <div class="actions-bar clearfix paddingT10 paddingB10" data-target="#files-table">
                <div class="col-xs-12 paddingT5 paddingB5 clearfix">
                    ...
                    @can ('Projects - Order confirmations delete')
            ...
            @can ('Projects - Order confirmations add')
            ...
            <div class="table-responsive">
                @include('projects._order_confirmations_list')
            </div>
        </div>
    </div>
@endsection
...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@order_confirmations_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@order_confirmations_upload', $project->id) }}");
    </script>
@endsection

    ...
    <div class="content-fluid offset">
        <div class="paddingL15 paddingR15">
            ...
            <div class="table-responsive">
                @include('projects._cuttings_list')
            </div>
        </div>
    </div>
@endsection
...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@cuttings_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@cuttings_upload', $project->id) }}");
    </script>
@endsection
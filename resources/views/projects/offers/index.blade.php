...
@section('content')
    ...
    <div class="content-fluid offset">
        <div class="paddingL15 paddingR15">
            ...
            @can ('Projects - Add offers')
            <a class="btn btn-sm btn-default marginT15 marginB15" type="button" data-toggle="modal" data-target="#upload-modal"><i class="material-icons">&#xE2C6;</i> {{ trans('Încărcare ofertă') }}</a>
            @endcan

            <div class="table-responsive">
                @include('projects.offers._offers_list')
            </div>
        </div>
    </div>
@endsection
...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@offers_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@offers_upload', $project->id) }}");
    </script>
@endsection
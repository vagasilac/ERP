...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@rfq_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@rfq_upload', $project->id) }}");
    </script>
@endsection
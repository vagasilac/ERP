    ...
    <div class="content-fluid offset">
        <div class="paddingL15 paddingR15">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a>{{ trans('Fișiere') }}</a></li>
                <li role="presentation"><a href="{{ action('ProjectsController@packing_list', $project->id) }}" >{{ trans('Packing list') }}</a></li>
            </ul>
            ...
            <div class="actions-bar clearfix paddingT10 paddingB10" data-target="#files-table">
                <div class="col-xs-12 paddingT5 paddingB5 clearfix">
                    ...
                    @can ('Projects - Delete transport files')
            ...
            @can ('Projects - Add transport files')
            <a class="btn btn-sm btn-default marginT15 marginB15" type="button" data-toggle="modal" data-target="#upload-modal"><i class="material-icons">&#xE2C6;</i> {{ trans('Încărcare fișiere') }}</a>
            @endcan

            <div class="table-responsive">
                @include('projects._transport_files_list')
            </div>
        </div>
    </div>
@endsection
...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@transport_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@transport_upload', $project->id) }}");
    </script>
@endsection
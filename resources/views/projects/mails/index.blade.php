    ...
    <div class="content-fluid offset">
        <div class="paddingL15 paddingR15">
            ...
            <div class="table-responsive">
                @include('projects.mails._mails_list')
            </div>
        </div>
    </div>
@endsection
...
@section('content-modals')
    ...
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ProjectsController@mails_multiple_destroy', $project->id], 'method' => 'DELETE']) !!}
...
@section('content-scripts')
    ...
    <script type="application/javascript">
        setDropzoneUpload("{{ action('ProjectsController@mails_upload', $project->id) }}");
    </script>
@endsection
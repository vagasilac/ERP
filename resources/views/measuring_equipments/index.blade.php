...
@section('title') {{ trans('Echipamente de măsurare') }} <a href="{{ action('MeasuringEquipmentsController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adăugare') }}</a> @endsection

@section('content')
    <div class="content-fluid">
        <div class="actions-bar clearfix" data-target="#me-table">
            <div class="col-xs-12 paddingT5 paddingB5 clearfix">
                ...
                @can ('Measuring Equipments delete')
        ...
        <div class="filters-bar clearfix" data-target="#me-table">
            <div class="col-xs-12">
        ...
        <div class="table-responsive marginT30 list-container">
            @include('measuring_equipments._me_list');
        </div>
    </div>
@endsection
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['MeasuringEquipmentsController@multiple_destroy'], 'method' => 'DELETE']) !!}

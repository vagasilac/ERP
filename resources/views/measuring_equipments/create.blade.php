...
@section('content')
    <div class="content-fluid">
        {!! Form::model(null, ['action' => 'MeasuringEquipmentsController@store', 'id' => 'saveForm', 'files' => true]) !!}
            ...
            <div class="tab-pane active row" id="output-container" role="tabpanel">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="form-group">
                        {!! Form::label('calibration_validity', trans('Valabilitatea calibrării'), ['class'=> 'control-label input-with-icon']) !!}
                        {!! Form::text('calibration_validity', \Carbon\Carbon::now()->format('d-m-Y'), ['class' => 'form-control has-datepicker']) !!}
                    </div>
                    <div class="form-group">

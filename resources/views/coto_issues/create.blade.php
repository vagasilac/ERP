...
@section('content')
    <div class="content-fluid">
        {!! Form::model(null, ['action' => 'CotoIssuesController@store', 'id' => 'saveForm', 'files' => true]) !!}
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('bias', Config::get('coto.issues.bias'), null, ['class' => 'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::select('priority', Config::get('coto.issues.priority'), null, ['class' => 'form-control']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('treatment_method', trans('Metoda de tratament') , ['class'=> 'control-label']) !!}
                {!! Form::select('treatment_method', Config::get('coto.issues.treatment_method'), null, ['class' => 'form-control', 'id' => 'treatment-method']) !!}
            </div>

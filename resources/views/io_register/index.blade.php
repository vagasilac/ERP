...
@section('title') {{ trans('Registru intrare-ieșire') }} <a href="{{ action('InputsOutputsRegisterController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adăugare') }}</a> @endsection

@section('content')
    <div class="content-fluid">
        <div class="actions-bar clearfix" data-target="#io-table">
        ...
        <div class="filters-bar clearfix" data-target="#io-table">
            <div class="col-xs-12">
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['InputsOutputsRegisterController@multiple_destroy'], 'method' => 'DELETE']) !!}

...
@section('title') {{ trans('Contextul Organizației') }} <a href="{{ action('CotoPartiesController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adăugare') }}</a> @endsection
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['CotoPartiesController@multiple_destroy'], 'method' => 'DELETE']) !!}

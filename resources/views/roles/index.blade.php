...
@section('title') {{ trans('Roluri') }} <a href="{{ action('RolesController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adaugă rol nou') }}</a> @endsection

@section('content')
    <div class="content-fluid">
        <div class="actions-bar clearfix" data-target="#roles-table">
        ...
        <div class="filters-bar clearfix" data-target="#roles-table">
            <div class="col-xs-12">
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['RolesController@multiple_destroy'], 'method' => 'DELETE']) !!}
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" >{{ trans('Șterge roluri') }}</h4>
                </div>
                <div class="modal-body">
                    {{ trans('Doriți să ștergeți aceste roluri') }}

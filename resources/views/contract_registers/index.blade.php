...
@section('title') {{ trans('Registrul contractelor') }} <a href="{{ action('ContractRegisterController@create') }}" class="action pull-right"><i class="fa fa-plus"></i> {{ trans('Adăugare') }}</a> @endsection

@section('content')
    <div class="content-fluid">
        <div class="actions-bar clearfix" data-target="#cr-table">
        ...
        <div class="filters-bar clearfix" data-target="#cr-table">
            <div class="col-xs-12">
        ...
        <div class="table-responsive marginT30 list-container">
            @include('contract_registers._cr_list');
        </div>
    </div>
@endsection
...
@section('content-modals')
    <div class="modal fade" id="delete-modal">
        {!! Form::open(['action' => ['ContractRegisterController@multiple_destroy'], 'method' => 'DELETE']) !!}

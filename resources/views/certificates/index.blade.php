...
@section('title') {{ trans('Certificate') }} @endsection
        ...
        @if (!is_null($url_hu))
            <div class="col-xs-12 marginT15 marginB15">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" @if($lang == 'ro') class="active" @endif><a href="{{ action('CertificatesController@index', [$id, 'ro']) }}">{{ trans('Ro') }}</a></li>
                    <li role="presentation" @if($lang == 'hu') class="active" @endif><a href="{{ action('CertificatesController@index', [$id, 'hu']) }}">{{ trans('Hu') }}</a></li>
                    <li role="presentation" @if($lang == 'en') class="active" @endif><a href="{{ action('CertificatesController@index', [$id, 'en']) }}">{{ trans('En') }}</a></li>
                </ul>
            </div>
